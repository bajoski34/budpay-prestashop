...
class PaymentExample extends PaymentModule
{
    ...
    public function hookDisplayPaymentByBinaries(array $params)
    {
        ...
        return $this->context->smarty->fetch('module:budpay/views/templates/hook/displayPaymentByBinaries.tpl');
    }
    ...
    private function getEmbeddedPaymentOption()
    {
        ...
        $embeddedOption->setAdditionalInformation($this->context->smarty->fetch('module:budpay/views/templates/front/paymentOptionEmbedded.tpl'));
